...
class PPTMEditLabel extends Component {
  state = {
    formStatus: {
      loading: false,
      success: false,
  ...
  handleEditLabel = async () => {
    ...
    try {
      let response = await LabelApi.updateLabel({
  ...
  render() {
    ...
    return (
      ...
      >
        <ModalHeader>
          <PageHeader>Edit Label</PageHeader>
        </ModalHeader>
        <ModalContent>
          <Form
...
export default connect(mapStateToProps)(PPTMEditLabel);
